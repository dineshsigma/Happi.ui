                        ...
                        >
                            ...
                            <div class="form-row Prebookdiv2">
                                <div class="col-sm-12 text-center header-text">
                                    <h2>Happi Republic Day offers</h2>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    ...
                                    <input type='hidden' name='type' value='republic-day-offers'>
...
export default {
    ...
    data() {
        return {
            image_url:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/e3d31a29-d4ba-4f76-9c34-6508105e83a1.jpg',
            image_urlm:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/43f6ee0e-38f0-4199-afa4-3a0bcb1db8f7.jpg',
            image_url2d:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/cb572610-b7b1-4969-b371-f2cccf1837ca.jpg',
            image_url2m:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/bd566ee5-85d8-4317-b7dd-54a10c7db931.jpg',
            homepageData: {},
    ...
    async asyncData({ $http, $seo }) {
        ...
        $seo({
            title: 'Best Offer mobiles online | Mobile Phone Offers | Buy mobiles online',
            templateTitle: 'Best Offer mobiles online | Mobile Phone Offers | Buy mobiles online',
            description:
