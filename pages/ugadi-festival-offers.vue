                        ...
                        >
                            ...
                            <div class="form-row Prebookdiv-ugadhi">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    ...
                                    <input type='hidden' name='type' value='ugadi-2023'>
                    ...
                    <div class="col-md-12 text-center align-center">
                        <a href="#pfn" class="anchor-tag">
                            <img
                                :src="`${image_url2d}`"
                                alt=""
                                class="desk-offer-hide pb-5"
                            />
                            <img
                                :src="`${image_url2m}`"
                                alt=""
                                class="mob-offer-hide pb-5"
                            />
                        </a>
                    </div>
                </div>
...
export default {
    ...
    data() {
        return {
            image_url:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/3a69b3dd-27f8-4e1d-86fb-3fe98a7bc14a.png',
            image_urlm:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/d33ad20d-39f5-49f6-8f58-11a1c3909611.png',
            image_url2d:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/05655c67-9efe-4da0-a5d2-34f769b02eb1.jpg',
            image_url2m:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/a122ed0a-bf9f-49d4-97ce-67b084242f22.png',
            homepageData: {},
    ...
    async asyncData({ $http, $seo }) {
        ...
        $seo({
            title: 'Happi Ugadi | Best Offer mobiles online | Mobile Phone Offers | Buy mobiles online',
            templateTitle: 'Happi Ugadi | Best Offer mobiles online | Mobile Phone Offers | Buy mobiles online',
            description:
