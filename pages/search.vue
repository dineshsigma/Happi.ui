                            ...
                            <div style="overflow-y: scroll; height: 180px;" v-if="brandVisible">
                                <ul id="brands" style="list-style-type: none;max-height: 180px;"
                                    ...
                                    <li v-if="brand.value != ''">
                                        ...
                                        <label
                                            :style="{ 'color': selectedBrands.includes(brand.value) ? '#fb9013' : 'black' }"
                                            @click="applyBrandFilter(brand)" class="filt-label filterClick">{{
                                                    brand.value
                                            }}</label>
                                    </li>
                                </ul>
                            ...
                            <div style="overflow-y: scroll; height: 180px;" v-if="priceVisible">
                                <ul id="prices" style="list-style-type: none;max-height: 180px;"
                                    ...
                                    <li v-if="price.from == 1 && price.count != 0">
                                        <label
                                            :style="{ 'color': priceFrom == '25' && priceTo == price.to ? '#fb9013' : 'black' }"
                                            @click="applyPriceFilter(price)" class="filt-label filterClick">Below ₹{{
                                                    mrpPriceFormat(price.to)
                                            }}
                                        </label>
                                    </li>
                                    <li
                                        v-if="price.value != '' && price.from != 1 && price.from != 60000 && price.count != 0">
                                        <!-- <input :value="price" type="checkbox" @click="applyPriceFilter(price)"> -->
                                        <label
                                            :style="{ 'color': priceFrom == price.from && priceTo == price.to ? '#fb9013' : 'black' }"
                                            @click="applyPriceFilter(price)" class="filt-label filterClick">₹{{
                                                    mrpPriceFormat(price.from)
                                            }} - ₹{{
        mrpPriceFormat(price.to)
}}</label>
                                    </li>
                                    <li v-if="price.from == 60000 && price.count != 0">
                                        <label
                                            :style="{ 'color': priceFrom == price.from && priceTo == '250000' ? '#fb9013' : 'black' }"
                                            @click="applyPriceFilter(price)"
                                            class="filt-label filterClick">₹{{ mrpPriceFormat(price.from) }} &
                                            Above</label>
                                    </li>
                                </ul>
                                ₹<input type="number" v-model="priceFrom" placeholder="min" id="min"> - ₹<input
                                    type="number" v-model="priceTo" placeholder="max" id="max"> &nbsp; <input
                                    style="background:#fb9013;border: 1px solid #fb9013" type="submit"
                                    @click="customPriceRange()" id="submit" value="Go">
                            ...
                            <div style="height: 180px;" v-if="ramVisible">
                                <ul id="brands" style="list-style-type: none;max-height: 180px;" v-for="ram in RamList">
                                    <li v-if="ram.value != ''">
                                        ...
                                        <label
                                            :style="{ 'color': selectedRams.includes(ram.value) ? '#fb9013' : 'black' }"
                                            @click="applyRamFilter(ram)" class="filt-label filterClick">{{ ram.value
                                            }}</label>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div style="overflow-y: scroll; height: 180px;" v-if="displayVisible">
                                <ul id="screens" style="list-style-type: none;max-height: 180px;"
                                    ...
                                    <li v-if="screen.value != ''">
                                        ...
                                        <label
                                            :style="{ 'color': selectedScreens.includes(screen.value) ? '#fb9013' : 'black' }"
                                            @click="applyDisplayFilter(screen)" class="filt-label filterClick">{{
                                                    screen.value
                                            }}</label>
                                    </li>
                                </ul>
                            ...
                            <div style="overflow-y: scroll; height: 180px;" v-if="camVisible">
                                <ul id="cams" style="list-style-type: none;max-height: 180px;" v-for="cam in CamList">
                                    <li v-if="cam.value != ''">
                                        ...
                                        <label
                                            :style="{ 'color': selectedCams.includes(cam.value) ? '#fb9013' : 'black' }"
                                            @click="applyCamFilter(cam)" class="filt-label filterClick">{{ cam.value
                                            }}</label>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div style="overflow-y: scroll; height: 180px;" v-if="networkVisible">
                                <ul id="networks" style="list-style-type: none;max-height: 180px;"
                                    ...
                                    <li v-if="network.value != ''">
                                        ...
                                        <label
                                            :style="{ 'color': selectedNetworks.includes(network.value) ? '#fb9013' : 'black' }"
                                            @click="applyNetworkFilter(network)" class="filt-label filterClick">{{
                                                    network.value
                                            }}</label>
                                    </li>
                                </ul>
                ...
                <div class="col-lg-9 col-sm-12">
                            ...
                            <div class="row selectedFilts">
                                <div v-for="brand in this.selectedBrands">
                                    <span title="Brand" class="selectedFilters">
                                        Brand: {{ brand }} &nbsp;<span class="remove" @click="removeBrand(brand)">
                                            <b>x</b> </span>
                                    </span>
                                </div>
                                ...
                                <div v-if="this.priceFrom > 25 && this.priceTo != 250000 && this.priceFrom != 25 && this.priceTo != 250000"> <span title="Price Range"
                            ...
                            <div class="sortContainer">
                                <v-row class="sortRow">
                                    <v-col class="col-lg-6 col-md-6 col-2">
                                        <!-- <label></label> -->
                                        <p class="filterMobile"
                                            style="color: #fb9013;cursor: pointer;font-size: 25px;margin-top: 10px;"
                                            @click="showMobileFilters()"><i class='fa fa-filter happi-filter'></i>&nbsp;
                                        </p>
                                    </v-col>
                    ...
                    <br>
                    <v-dialog transition="dialog-bottom-transition" fullscreen v-model="this.EnableMobileFilters"
                        width="600" class="col-sm-12 filterMobile">
                                ...
                                <div class="card col-12" v-if="filteredList().length">
                                    ...
                                    <div class="search-wrapper" v-if="brandVisible">
                                        <i class="fa fa-search"></i> &nbsp;<input type="text" id="search"
                                            v-model="search" placeholder="Search brand" />
                                        <hr>
                                    </div>
                                        ...
                                        <ul id="prices" style="list-style-type: none;max-height: 180px;"
                                            ...
                                            <li v-if="price.from == 1 && price.count != 0">
                                                <label
                                                    :style="{ 'color': priceFrom == '25' && priceTo == price.to ? '#fb9013' : 'black' }"
                                                    @click="applyPriceFilter(price)"
                                                    class="filt-label filterClick">Below ₹{{
                                                            mrpPriceFormat(price.to)
                                                    }}
                                                </label>
                                            </li>
        ...
        mrpPriceFormat(price.to)
                            ...
                            <input type="text" v-model="search" placeholder="Search RAM Size"/>
                                    ...
                                    <div style="height: 180px;" v-if="mobileRamVisible">
                                        <ul id="brands" style="list-style-type: none;max-height: 180px;"
                                            v-for="ram in RamList">
                                            <li v-if="ram.value != ''">
                                                <!-- <input :value="ram" type="checkbox" @click="applyRamFilter(ram)"> -->
                                                <label
                                                    :style="{ 'color': selectedRams.includes(ram.value) ? '#fb9013' : 'black' }"
                                                    @click="applyRamFilter(ram)" class="filt-label filterClick">{{
                                                            ram.value
                                                    }}</label>
                                            </li>
                                        </ul>
                                    ...
                                    <div style="overflow-y: scroll; height: 180px;" v-if="displayVisible">
                                        <ul id="screens" style="list-style-type: none;max-height: 180px;"
                                            ...
                                            <li v-if="screen.value != ''">
                                                ...
                                                <label
                                                    :style="{ 'color': selectedScreens.includes(screen.value) ? '#fb9013' : 'black' }"
                                                    @click="applyDisplayFilter(screen)"
                                                    class="filt-label filterClick">{{ screen.value }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="card col-12" v-if="CamList.length">
                                    ...
                                    <div style="overflow-y: scroll; height: 180px;" v-if="camVisible">
                                        <ul id="cams" style="list-style-type: none;max-height: 180px;"
                                            v-for="cam in CamList">
                                            <li v-if="cam.value != ''">
                                                <!-- <input :value="cam" type="checkbox" @click="applyCamFilter(cam)"> -->
                                                <label
                                                    :style="{ 'color': selectedCams.includes(cam.value) ? '#fb9013' : 'black' }"
                                                    @click="applyCamFilter(cam)" class="filt-label filterClick">{{
                                                            cam.value
                                                    }}</label>
                                            </li>
                                        </ul>
                                    ...
                                    <div style="overflow-y: scroll; height: 180px;" v-if="networkVisible">
                                        <ul id="networks" style="list-style-type: none;max-height: 180px;"
                                            ...
                                            <li v-if="network.value != ''">
                                                ...
                                                <label
                                                    :style="{ 'color': selectedNetworks.includes(network.value) ? '#fb9013' : 'black' }"
                                                    @click="applyNetworkFilter(network)"
                                                    class="filt-label filterClick">{{ network.value }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <v-footer fixed flat
                                style="background: #fb9013;background: white; justify-content: center;">
                                <v-card-actions>
                                    <v-spacer></v-spacer>
                                    <v-btn text @click="closeMobileFilter()" class="close_filter">
                                        APPLY FILTERS
                                    </v-btn>
                                    <v-btn text @click="clearMobileFilter()" class="clear_filter">
                                        REMOVE FILTERS
                                    </v-btn>
                                </v-card-actions>
                            </v-footer>
                    ...
                    <div class='row' style='padding: 10px !important;' v-if='items.length != 0'>
                        ...
                        <div class='col-lg-3 col-md-3 col-6' v-for='(item, index) in items'
                            ...
                            <div class='ps-product' style='padding: 15px !important;'>
                                <div>
                                    <p v-if='item.stock.raw != 0' style='cursor:pointer;float:left;' class='icons'
                                        title='Add to cart' @click.prevent='addItemToCart(item)'>
                                        <i class='icon-bag2'></i>
                                    </p>
                                ...
                                <div class='ps-product__thumbnail'>
                                    <nuxt-link :to='`/${item.linker.raw}`'>
                                        <div class='image-b'>


                                            <img v-if='item.image_url != undefined' class='hit-image-1'
                                                :src='`${item.image_url.raw}`' :alt='`${item.name.raw}`' />
                                        </div>
                                    </nuxt-link>
                                ...
                                <div class='ps-product__container'>
                                    <div class='ps-product__content'>
                                        <nuxt-link :to='`/${item.linker.raw}`' class='ps-product__title'>
                                            {{ item.name.raw }}
                                        </nuxt-link>
                                        ...
                                        <!-- <div>
                                                ...
                                                <div v-if="item.mrp" class="mrp-products" style="float:left">
                                                    <p>
                                                    <s>₹ {{ mrpPriceFormat(item.mrp.raw) }}</s> 
                                                    </p>
                                                </div>
                                                <div>
                                                    <div v-if="item.mrp" style="float:right;">
                                                    <p style="color:#fb9013"><b>
                                                        {{ priceFormat(item.display_price.raw) }}
                                                    </b></p>
                                                    </div>
                                                    <div v-else style="float:center;">
                                                    <p style="color:#fb9013"><b>
                                                        {{ priceFormat(item.display_price.raw) }}
                                                    </b></p>
                                                    </div>
                                                ...
                                                <strong v-if="item.mrp" style="font-size: 15px; float:left; margin-left:5px; padding:2px;border-radius:4px;background-color:#CC4600; color:#fff">{{ (( (parseInt(item.mrp.raw) - parseInt(item.payprice.raw)) / (item.mrp.raw) ) * 100 ).toFixed(0) }}%</strong>
                                                <br>
                                            </div> -->
                                        <div class="container">
                                            <div class="row"
                                                v-if="(parseInt(item.mrp.raw) - parseInt(item.payprice.raw) > 5)">
                                                <div v-if="item.mrp"
                                                    class="mrp-products col-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <p>
                                                        <s>₹{{ mrpPriceFormat(item.mrp.raw) }}</s>
                                                    </p>
                                                </div>
                                            ...
                                            <div v-else class="row display_price">
                                                <p style="color:#fb9013;font-size: 14px;"><b>
                                                        {{ priceFormat(item.display_price.raw) }}&nbsp;
                                                    </b></p>
                                            </div>
                                            <div class="row">
                                                <div class=" col-4 col-lg-5 col-md-6 col-sm-1"
                                                    v-if="(parseInt(item.mrp.raw) - parseInt(item.payprice.raw) > 5)"
                                                    style="padding-bottom:30px">
                                                    <strong v-if="item.mrp"
                                                        style="font-size: 12px; padding:2px;border-radius:4px;background-color:#CC4600; color:#fff">
                                                        {{ (((parseInt(item.mrp.raw) - parseInt(item.payprice.raw)) /
                                                                (item.mrp.raw)) * 100).toFixed(0)
                                                        }}%&nbsp;OFF</strong>

                                                </div>
                                                <div class=" col-8 col-lg-8 col-md-6 col-sm-11">
                                                    <p v-if='item.stock.raw == 0' class='mb-0'
                                                        style='color:red;font-size:12px;float:right'>
                                                        Out of stock
                                                    </p>
...
export default {
    ...
    data() {
        return {
            ...
            sortPrices: ['Price - High to low', 'Price - Low to High', 'Select'],
    ...
    async created() {
        ...
        //     }
        // }
        var searchText = this.$route.query.q;
        ...
        this.sortDetail = this.$route.query?.sort || 'Select'
        ...
        if (this.priceFrom > 0) {
            ...
            this.minValue = this.priceFrom;
            this.maxValue = this.priceTo;
        }


        var sort = [];
        //console.log("sort",this.sortDetail)
        if (this.sortDetail == "Select") {
            sort.push({ "_score": "desc" })
        }
        else if (this.sortDetail == "Price - Low to High") {
            sort.push({ "_score": "desc" }, { "payprice": "asc" })

        } else {
            sort.push({ "_score": "desc" }, { "payprice": "desc" })
        }
    ...
    async asyncData({ params, redirect, $axios, route }) {
        var result;
        var customBreadCrumb = route.query.q.split("/")[0]
        var breadCrumb = [
            {
                text: 'Home',
                url: '/'
    ...
    methods: {
        ...
        async applyRamFilter(ram) {
            ...
            //     x = [...this.selectedRams,ram.value.replace('&','-')]
            // }
        ...
        async onPageChange(pageNo) {
            ...
            this.page = pageNo;
            var searchText = this.$route.query.q.replaceAll(' ', '*');
            this.filterFetch()
        },
        ...
        async filterFetch() {
            ...
            setTimeout(async () => {
                ...
                if (url != '') {
                    history.pushState(`/search?q=${this.$route.query.q}${url}`, `/search?q=${this.$route.query.q}${url}`, `/search?q=${this.$route.query.q}${url}`);
                }
            }, 1000)
        },
        //funtion end for filters selection and sort selection
