                        ...
                        >
                            ...
                            <div class="form-row Prebookdiv2 mb-3">
                                <div class="col-sm-12 text-center header-text">
                                    <h2>Samsung Galaxy Pre Reserve</h2>
...
export default {
    ...
    data() {
        return {
            image_url:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/cb24a5d5-b8ae-41f1-a49c-a5bb71efc1fc.png',
            image_urlm:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/9f03e454-46e6-4650-8bf3-abf86815037a.png',
            image_url2d:
