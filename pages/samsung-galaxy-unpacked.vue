<template>
    <div class="body">
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/6126af23-b152-4d7b-8432-85e352cc330e.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block"/>
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/0dd562ad-3f88-4d7f-8bb9-9e5e67240023.png"
            ...
            <div class="formbody" id="smf">
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="header">
                            <h1 v-if="seconds > 0">{{ days }} days {{ hours }} : {{ minutes }} : {{ seconds }}</h1>
                            <br><br>
                            <h2>Get Offer Details, Enquire Now!</h2>
                            <p>All fields marked (*) are mandator</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type='hidden' name='type' value='samsung-galaxy-unapcked'>
                ...
                <div class="row  flex-row flex-sm-row-reverse">
                    <div class="col-12 col-sm-6  order-2">
                        <video autoplay loop muted width="100%">
                            <source src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/c54c878b-97d5-4901-ac02-4682622180a0.mp4" type="video/mp4">
                        </video>
                    </div>
                    <div class="col-12 col-sm-6 align-self-center order-1">
                        <div class="video-content text-center text-sm-left">
                            <h3>Step into the future with the highly anticipated release of the all-new Samsung Galaxy, arriving on <br> <span class="strike">July 23, 2023</span> </h3>
                        </div>
                    </div>
                </div>
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="col-md-12 mt-5 mb-5 pt-5">
                        <h3 class="text-center text-light">Secure your place at the forefront of technology by pre-reserving your very own device today and enjoy exclusive benefits worth an astounding <span class="strike">Rs.5000 /-</span>.</h3>
                    </div>
                    <div class="col-12 col-sm-4 video-tag">
                        <video autoplay loop :muted=this.video1 height="640" width="100%" id="ad1">
                            <source src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/bb22c301-b572-45ef-8952-10da1bab4318.mp4" type="video/mp4">
                        </video>
                        <button @click="toggleMute(1)" class="button-audio-toogle"><i class="fa fa-volume-off" v-show="this.one"></i> <i class="fa fa-volume-up" v-show="!this.one"></i></button>
                    </div>
                    <div class="col-12 col-sm-4 video-tag">
                        <video autoplay loop :muted=this.video2 height="640" width="100%" id="ad2">
                            <source src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/8a8fe471-933e-4752-b2c6-c5960799afaa.mp4" type="video/mp4">
                        </video>
                        <button @click="toggleMute(2)" class="button-audio-toogle"><i class="fa fa-volume-off" v-show="this.two"></i> <i class="fa fa-volume-up" v-show="!this.two"></i></button>
                    </div>
                    <div class="col-12 col-sm-4 video-tag">
                        <video autoplay loop :muted=this.video3 height="640" width="100%" id="ad3">
                            <source src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/d883c202-d5ff-4cec-9959-60ed7592aa14.mp4" type="video/mp4">
                        </video>
                        <button @click="toggleMute(3)" class="button-audio-toogle"><i class="fa fa-volume-off" v-show="this.three"></i> <i class="fa fa-volume-up" v-show="!this.three"></i></button>
                    </div>
                </div>
            </div>  
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            three: true,
            videoSound: ''
            // countdownTo: new Date(July 9, 2023 12:00:00).getTime()
        }
    },
    ...
    async asyncData({ $http, $seo }) {
        ...
        $seo({
            title: 'samsung-galaxy-unapcked',
            templateTitle: 'samsung-galaxy-unapcked',
            description:
                'samsung-galaxy-unapcked',
            keywords:
                'samsung-galaxy-unapcked',
            openGraph: {
                site: 'Happi Mobiles',
    ...
    methods: {
        ...
        getCountDown(){
            ...
            var countDownDate = new Date("July 26, 2023 16:30:00").getTime();
            ...
            this.days<10 ? this.days = '0' + this.days.toString() : this.days.toString();
            this.hours<10 ? this.hours = '0' + this.hours.toString() : this.hours.toString();
            this.minutes<10 ? this.minutes = '0' + this.minutes.toString() : this.minutes.toString();
            this.seconds<10 ? this.seconds = '0' + this.seconds.toString() : this.seconds.toString();

            // console.log(this.days, this.hours, this.minutes, this.seconds, 'TIME HERE');
        },
        toggleMute(id) {
            if(id == 1){
                this.videoSound = document.getElementById("ad1");
                this.one = !this.one;
                if (this.videoSound.muted) {
                    this.video1= false;
                } else {
                    this.video1 = true;
                }
            } else if(id == 2){
                this.videoSound = document.getElementById("ad2");
                this.two = !this.two;
                if (this.videoSound.muted) {
                    this.video2= false;
                } else {
                ...
                this.videoSound = document.getElementById("ad3");
...
.video-section{
    // background: rgba(255, 153, 0, 0.959);
    background:#323232;
    padding:6rem 0;
    .video-content{
        display: flex;
        ...
        h3{
            color: #ffffff;
            // font-size: 3rem;
            letter-spacing: 2.2px;font-size: 2.5rem;line-height: 1.25;font-weight: 400; font-family: 'Roboto' sans-serif !important;margin-bottom: 3rem;
        }
    }
    h3{letter-spacing: 2.2px;font-size: 2.5rem;line-height: 1.25;font-weight: 400; font-family: 'Roboto' sans-serif !important;}
    h3>span{font-weight:600; color: #ffffff; font-family: 'Roboto' sans-serif !important;}
    .strike{position: relative;z-index: 9;}
    .strike::before{
        content: "";
        position: absolute;
        height: 12px;
