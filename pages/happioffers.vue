                        ...
                        >
                            ...
                            <div class="form-row Prebookdiv2">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    ...
                                    <input type='hidden' name='type' value='happi-offers'>
...
export default {
    ...
    data() {
        return {
            image_url:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/6550f97a-db4c-405b-9d6b-be2a5f61ddf7.png',
            image_urlm:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/7dcfc14f-52d0-4889-8e5f-3b8db329b5b8.png',
            image_url2d:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/18cb0265-2098-4904-b43d-d4415027b95e.png',
            image_url2m:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/17972569-2d75-4f1c-96c4-bcb3bdf83d09.png',
            homepageData: {},
    ...
    async asyncData({ $http, $seo }) {
        ...
        $seo({
            title: 'Happi Hearts | Best Offer mobiles online | Mobile Phone Offers | Buy mobiles online',
            templateTitle: 'Happi Hearts | Best Offer mobiles online | Mobile Phone Offers | Buy mobiles online',
            description:
