<template>
    <div class="body">
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/697e7e5e-cc4a-4e7b-94f9-be5d4a4062e0.jpg"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block"/>
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/31fe09c2-b230-4249-8cf7-f04c4f595900.jpg"
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type='hidden' name='type' value='indias-best-offers-on-tv'>
        ...
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/dcfa0b3e-9af2-466f-9de2-b46fdfa34c48.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/629fdde7-aaf7-4054-983b-362dec028a0f.png"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div>
    </div>
...
export default {
    ...
    async asyncData({ $http, $seo }) {
        ...
        $seo({
            title: 'indias best offers on TV',
            templateTitle: 'indias best offers on TV',
            description:
                'indias best offers on TV',
            keywords:
                'indias best offers on TV',
            openGraph: {
                site: 'Happi Mobiles',
