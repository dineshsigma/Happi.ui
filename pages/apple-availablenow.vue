<template>
    <div class="body">
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/0ac02ee9-c977-4f4a-876c-eb969eb11225.jpg"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block"/>
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/92a69964-664b-49e1-817a-ae7266b67d19.jpg"
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type='hidden' name='type' value='apple-pre-book-now'>
                        ...
                        <div class="form-group align-item-center justify-content-center text-center">
                            <div
                                class="captchcls d-flex align-item-center justify-content-center justify-content-sm-between">
                                 <select name="Brand" placeholder="Brand" class="selectBrand" v-model="Brand" required >
        ...
        <div>
         <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/64a474a2-83ab-4a53-983b-751f60582917.jpg"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block"/>
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/436b8ff2-2765-4d15-a1af-51f8b19ae5dd.jpg"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div>
        <!-- <div>
         <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/3cb69de1-3e0b-4506-973b-cdac24e7511f.jpg"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block"/>
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/58d1f8d1-fbac-40c1-b7a8-68bd25f930b6.jpg"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div> -->
    </div>
...
export default {
    ...
    async asyncData({ $http, $seo }) {
        ...
        $seo({
          //Apple Pre Book Now
            title: 'Apple Pre Book Now',
            templateTitle: 'Apple Pre Book Now',
            description:
                'Apple Pre Book Now',
            keywords:
                'Apple Pre Book Now',
        ...
        async validate() {
          console.log("this.",this.nameReq,this.phone,this.Brand!= undefined)
            if (Number(this.userSum) === this.captchaSum) {
                if (this.nameReq != '' && this.Brand!=undefined && this.phoneNo.length == 10 && (/^\d+$/.test(this.phoneNo)) && (/^[a-zA-Z\s.,]+$/.test(this.nameReq)) && Number(this.userSum) === this.captchaSum) {
