<template>
    <div class="body">
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/1f089033-a615-4022-90a8-105a546d1fc8.jpeg"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block"/>
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/8282bbbf-b59e-4b67-9790-de2229bfdbfa.jpeg"
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type='hidden' name='type' value='apple-ipad'>
        ...
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/a3d0cf9a-f08f-4987-bd80-3d1f8235b7b1.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/d9e8b316-4474-40d6-9dba-30f8cc6f4b72.jpeg"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div>
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/b122302f-5cc2-41ea-b4e5-d0ef092c2322.jpeg"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/dad70771-1049-4373-84f4-70a0f66839dc.jpeg"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div>
    </div>
