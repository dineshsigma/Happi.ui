<template>
    <div class="body">
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/6c11ca9c-f25d-4f27-a2ac-c5b8c8ade2d5.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block"/>
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/58b9583c-71c3-4efe-b946-46a8ccc5584f.png"
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type='hidden' name='type' value='monsoon-sale-mobiles'>
        ...
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/79a5e484-a65b-423c-8a09-0af7bc1f4e18.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/e9ccae31-d127-4cb9-917e-5d86164632b8.png"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div>
    </div>
...
export default {
    ...
    async asyncData({ $http, $seo }) {
        ...
        $seo({
            title: 'Happi Monsoon Sale',
            templateTitle: 'Happi Monsoon Sale',
            description:
                'Happi Monsoon Sale',
            keywords:
                'Happi Monsoon Sale',
