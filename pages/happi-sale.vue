<template>
    <div class="body">
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/f22c2309-fdb8-43ea-97ae-1cb0340828c0.jpg"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/56df8261-de1b-4e32-8eb9-ccecea14eb63.jpg"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div>
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/e4ee4d1e-9638-44f2-8f38-0ca13b5a0b98.jpeg"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/1bf59bcb-81c5-4ddb-a8e0-6cf400ceeb6d.jpg"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div>
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/3b51eb17-a16c-490c-b2e7-524fbb747182.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/3b51eb17-a16c-490c-b2e7-524fbb747182.png"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
                <!-- <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/c7b87c1b-63f6-4730-ada9-59a103cde6f1.jpeg"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" /> -->
            </a>
        </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type='hidden' name='type' value='happi-sale'>
        ...
        <!-- <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/51c3f004-3e88-4b4f-97cc-043527ac9626.jpeg"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/a94cbf14-fea7-4bf4-b841-6595c0a2d1e8.jpeg"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div> -->
    </div>
