<template>
    <div class="body">
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/584059a2-a9bf-4e06-8c71-ed2252019b84.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block"/>
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/2bc8a4f1-b290-4dc3-acf5-a5fc9d5bdfc0.png"
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type='hidden' name='type' value='indias-best-offers-on-laptops'>
        ...
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/596e5a95-2510-4ceb-8f42-d67458bfb200.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/f8548052-d2dc-4eb9-9687-251affb01adf.png"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div>
    </div>
...
export default {
    ...
    async asyncData({ $http, $seo }) {
        ...
        $seo({
            title: 'indias best offers on Laptops',
            templateTitle: 'indias best offers on Laptops',
            description:
                'indias best offers on Laptops',
            keywords:
                'indias best offers on Laptops',
            openGraph: {
                site: 'Happi Mobiles',
