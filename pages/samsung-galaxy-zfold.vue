<template>
    <div class="body">
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/8a9b7347-91e0-49db-853b-e484c9723c43.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block"/>
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/01d2b4d0-2f17-4bc2-beba-23590e675d8f.png"
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type='hidden' name='type' value='samsung-pre-book-now'>
        ...
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/f8567f08-4314-48ea-909e-c8262cc8a801.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/5c49b74b-eb06-451e-bc88-28219cfdda34.png"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div>
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/b5beaf05-456a-4d5a-8388-d7c8d285c4ce.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/d3261174-d5a6-401a-8b82-0304519f773b.png"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div>
    </div>
...
export default {
    ...
    async asyncData({ $http, $seo }) {
        ...
        $seo({
            title: 'samsung-galaxy-zfold',
            templateTitle: 'samsung-galaxy-zfold',
            description:
                'samsung-galaxy-zfold',
            keywords:
                'samsung-galaxy-zfold',
            openGraph: {
                site: 'Happi Mobiles',
