<template>
    <div class="container-fluid">
        <div class="row d-flex align-item-center justify-content-center mb-2">
                    ...
                    >
                        <a href="#pfn" class="anchor-tag"
                            ><img
                                :src="`${image_url}`"
                                alt=""
                                class="desk-offer-hide"
                            />
                            <img
                                :src="`${image_urlm}`"
                                alt=""
                                class="mob-offer-hide"
                            />
                        </a>
                        <h1 class="text-main-head">
                            Get the new Galaxy A and experience 5G the awesome way
                        </h1>
                    </div>
                    <div class="col-lg-12 col-md-12" id="pfn">
                        <form
                            id="leads"
                        ...
                        >
                            ...
                            <div class="form-row Prebookdiv2 mb-3">
                                <div class="col-sm-12 text-center header-text">
                                    <h2>Samsung Galaxy A offers</h2>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    ...
                                    <input type='hidden' name='type' value='samsung-galaxy-a'>
...
export default {
    ...
    data() {
        return {
            image_url:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/7cf233cd-c97a-4eec-9273-086c0110264e.png',
            image_urlm:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/e8866b57-9627-4d29-8a57-95196d4f8a4f.png',
            image_url2d:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/3aa588db-e442-4aef-baf5-6573235b89ff.png',
            image_url2m:
                'https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/cae1b43c-fbd9-4a67-88a3-684a00b8937a.png',
            homepageData: {},
    ...
    async asyncData({ $http, $seo }) {
        ...
        $seo({
            title: 'Samsung-GalaxyA',
            templateTitle: '%title% - Happi Mobiles',
            description:
                'Buy the new AirPods Pro 2. Richer audio quality, up to 2x more Active Noise Cancellation, Adaptive Transparency, and Personalised Spatial Audio.',
            keywords:
                'airpods pro 2,airpods pro 2 price,airpods pro 2 cost,airpods pro 2 price,airpods pro 2 features.',
            openGraph: {
                site: 'Happi Mobiles',
                type: 'website',
                title: 'Buy APPLE Airpods Pro 2 at the best price - Happi mobiles ',
                description:
                    'Buy the new AirPods Pro 2. Richer audio quality, up to 2x more Active Noise Cancellation, Adaptive Transparency, and Personalised Spatial Audio.',
            },
            twitter: {
    ...
    methods: {
        async validate() {
            // console.log(1, this.nameReq, this.phoneNo)
        ...
        async formValidationsDesk() {
            let token_desk = null;
            try {
                console.log(token_desk, 'TOKEN');
                token_desk = await this.$recaptcha.getResponse();
                console.log(token_desk, 'TOKEN');
                document.getElementById('token_desk').value = token_desk;
                await this.$recaptcha.reset();
            } catch (error) {
                console.log('Login error:', error);
            }
            console.log('token', token_desk);
            if (token_desk !== null) {
                document.getElementById('leadsDesk').submit();
                //alert('Cool...');
                return true;
            } else {
                alert('Please check the Captcha');
