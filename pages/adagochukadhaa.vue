<template>
    <div class="body">
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/c33ba3bc-b664-46f3-b1e7-9b0d2f2359b6.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block"/>
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/31fec03a-26ee-40a6-8075-4366b32b1611.png"
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type='hidden' name='type' value='adagochukadhaa'>
        ...
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/031c9bd2-69cb-4cc8-a152-e0a8b289a261.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/c123f7ae-1cf2-4aed-8270-4d35dc172837.png"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div>
    </div>
...
export default {
    ...
    async asyncData({ $http, $seo }) {
        ...
        $seo({
            title: 'adagochukadhaa',
            templateTitle: 'adagochukadhaa',
            description:
                'adagochukadhaa',
            keywords:
                'adagochukadhaa',
