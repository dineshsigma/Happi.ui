<template>
    <div class="body">
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/89be901c-23fc-4258-9249-7fe6bc740c24.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block"/>
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/563adc90-d937-4c49-8bd7-d6b5f3b6e018.png"
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type='hidden' name='type' value='freedom-sale'>
        ...
        <div>
            <a href="#smf">
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/7ff91502-4d86-46c6-9d21-73a9d031e689.png"
                    alt="happi_earphones" width="100%" class="d-none d-sm-block" />
                <img src="https://s3.ap-south-1.amazonaws.com/happimobiles/retool-upload/f72a3ecd-8599-4cbb-8b6a-d8d53cab9d6a.png"
                    alt="happi_earphones" width="100%" class="d-block d-sm-none" />
            </a>
        </div>
    </div>
