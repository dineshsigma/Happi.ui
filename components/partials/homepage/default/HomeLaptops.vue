        ...
        <div class='ps-container '>
            <div class='col-12 ps-section-content mobile-section-heading'>
                <h3  class='ps-block__left header-title-mobile desktop-hide'>
                    {{ newArrivals.title }}
                    <a @click="handleSeeAll" class="mobile-seeall desktop-hide">SEE ALL</a>
                </h3>
            ...
            <div class="row">
                <div class="col-12">
                    <div
                        class='ps-carousel'
                        v-swiper:dealOfDayCarousel='carouselSettingLaptops'
                        >
            ...
            <div class="row" style="display: none;">
                <div class="col-12">
                    <VueSlickCarousel class='laptops-carousel' v-bind="homelaptopscroll"
                                v-if="(newArrivals.products.length > 0)">
                                <div class='swiper-slide card-layout card-phones' v-for='(product, index) in newArrivals.products'
                                    :key="index">

            <!---------------------------------------- Producct Iner Desktop Component-->
                                    <product-inner-new :product='product' :key='product.id.raw' />
                <!---------------------------------------- Producct Iner Desktop Component-->
            ...
            <!-- <div
                class='ps-carousel'
                v-swiper:homeLaptopsCarousel='carouselSetting'
                >
                    <div class='swiper-wrapper col-9'>
                        <div
                            class='swiper-slide card-layout card-phones'
    ...
    methods: {
        handleSeeAll() {
            ...
            if(this.newArrivals.products[0].category.raw[0] == 'mobile'){
                this.categoryRoute = this.newArrivals.products[0].category.raw[0] + 's/all';
            } else {
                this.categoryRoute = this.newArrivals.products[0].category.raw[0] + '/all';
            }
                this.$router.push(this.categoryRoute);
        }
    },
    async mounted() {
