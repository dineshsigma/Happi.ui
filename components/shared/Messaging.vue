<template>
  <div>
    <div>
      <button :disabled="listenersStarted" @click="startListeners"
      ...
      <button :disabled="idToken === ''" class="mb-1" @click="sendTestMessage">
...
export default Vue.extend({
  ...
  methods: {
    ...
    sendTestMessage() {
      try {
        setTimeout(() => {
          // wait 5 seconds so you have time to switch away from the page to tests the service-worker
