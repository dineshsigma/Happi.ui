...
// Hero Animation
  ...
  iconsTimeline
    ...
    .to("#frount_strip_9months", 4, { autoAlpha: 1, x: 0,delay:2 })
      
    .to("#text_9months_main", 2, { autoAlpha: 1,delay:2 })
    ...
    .fromTo(
      ...
      { x: 300, scale: 1, transformOrigin: "center"},
...
Nitography_cemara_action_timeline_effect.fromTo("#spec-camera-text,#spec-camera-heading", 3,
  { scale: 10, transformOrigin: "center", autoAlpha: 0 },{ autoAlpha: 1, scale: 1, transformOrigin: "center" })
.to("#spec-camera-pera", 0.3, { autoAlpha: 1, scale: 1, transformOrigin: "center"} );
